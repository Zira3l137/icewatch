...
use elements::explorer::ExplorerNode;
use iced::Element;
use iced::Point;
use iced::Task;
use iced::Theme;
...
pub(crate) use messages::HomeMessage;
pub(crate) use messages::JournalMessage;
pub(crate) use messages::RulesMessage;
pub(crate) use messages::watch_directory_stream;
use view::MainView;
...
pub struct State {
    ...
    sorted: Vec<(PathBuf, PathBuf)>,
    current_action_type: Option<ActionType>,
