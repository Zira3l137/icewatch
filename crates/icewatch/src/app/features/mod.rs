...
pub(crate) const SCROLLBAR_SPACING: f32 = 10.0;
...
pub(crate) const TOOLTIP_DELAY_MS: u64 = 500;
pub(crate) const PROGRESS_INTERVAL_MS: u128 = 100;
pub(crate) const PROGRESS_FRAME_COUNT: usize = 6;
